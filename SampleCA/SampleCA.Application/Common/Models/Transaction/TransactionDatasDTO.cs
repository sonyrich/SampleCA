...
{
    public class TransactionDatasDTO : IMapFrom<TransactionDatas>
    {
        ...
        public IList<TransactionGCEDatasDTO> TransactionGCEDatas { get; set; }
        public IList<TransactionGCRDatasDTO> TransactionGCRDatas { get; set; }
    }
}
